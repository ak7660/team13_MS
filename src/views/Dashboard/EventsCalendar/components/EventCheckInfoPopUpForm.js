            ...
            {event.userType === "volunteer" && (
              <Box ml={2}>
                ...
                <StatLabel fontSize="md" fontWeight="" mb={2}>
                  Hey, thanks for helping us out! We look forward to having you.
                  Before you get started, please watch the training materials
                  below to get integrated into our system!
                </StatLabel>
                <Stack spacing={2} mt={2}>
                  {event.trainingMaterials &&
                ...
                <StatLabel fontSize="md" fontWeight="" mt={0}>
                  Please find your delegated tasks below! We try our best to
                  match you to the tasks you are interested in and to your
                  available time slots. Make sure to have fun!
                </StatLabel>

                <Stack spacing={4} mt={2}>
                  {event.delegatedTasks &&
                    event.delegatedTasks.map((taskInfo, index) => (
                      ...
                      >
                        ...
                        <Select
                          ...
                          borderColor="gray.800"
                          bg={
                            completedTasks[taskInfo.task] === "completed"
                              ? "green.200"
                              : "white"
                          }
                        >
